...
// 2. Публичный endpoint (без API ключа, с rate limiting)
app.post('/public/deposit/generate', publicLimiter, async (req, res) => {
    try {
...
const server = app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`✅ PUBLIC RATE LIMITING: 50 requests per 15 minutes per IP`);
