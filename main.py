...
app = FastAPI(title="Volatility Hunter Sniper Bot", version="8.3.6-bitget-oneway-close-fix")
...
async def health_check():
    return {"status": "online", "system": "Volatility Hunter Sniper Live Guard", "version": "8.3.6-bitget-oneway-close-fix"}
...
async def preflight():
    ...
    try:
        ...
        return {
            "status": "error",
            "version": "8.3.6-bitget-oneway-close-fix",
